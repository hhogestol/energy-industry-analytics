---
title: "lab6_ene434_Håvard_Høgestøl"
...
Unfortunately, I was not able to visualize the forecast in a the plot. The data is modeled with the Fourier terms at monthly, weekly, and daily levels. However, I'm not sure if I used the correct K-value for the monthly Fourier term. This could have been the reason why I was not able to forecast the data one year ahead. 
...
Note: If I could figure out how to omit the first 9 months of 2019 from the plots, I would be able to zoom in and better illustrate the forecast.  
